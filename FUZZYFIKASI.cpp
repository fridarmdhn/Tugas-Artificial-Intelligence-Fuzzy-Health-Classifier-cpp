...
int main()
{
    ...
    cout << "Masukkan x untuk tinggi badan : ";
    cin >> x_explv;
    cout << "Masukkan x untuk berat badan : ";
    cin >> x_exptm;
    fuzzification(x_explv, 150, 165, 180, uLow, uMedium, uHigh); //exploration level
    fuzzification(x_exptm, 40, 50, 60, uFast, uNormal, uSlow); //exploration time

    cout << " Kategori tinggi badan : " << endl;
    cout << " Pendek = " << uLow << endl;
    cout << " Normal = " << uMedium << endl;
    cout << " Tinggi = " << uHigh << endl;

    cout << " Kategori berat badan : " << endl;
    cout << " Kurus = " << uFast << endl;
    cout << " Normal = " << uNormal << endl;
    cout << " Gemuk = " << uSlow << endl;
    ...
    cout << "\nConclusion : " << endl;
    cout << "Perlu Vitamin = " << poor << endl;
    cout << "Bisa Vaksin = " << average << endl;
    cout << "Perlu Olahraga = " << awesome << endl;

    //sample for defuzzification
    determine_sample(0,40,80,100,sample1,sample2,sample3);
    cout << "\nNilai sampel untuk defuzzification : " << endl;
    cout << "Perlu Vitamin  = " << sample1 << endl;
    cout << "Bisa Vaksin  = " << sample2 << endl;
    cout << "Perlu Olahraga  = " << sample3 << endl;

    //defuzzification
    defuzzification(poor, average, awesome, sample1, sample2, sample3, reward);
    cout << "\n\nHasil Defuzzifikasi :" << endl;
    cout << reward << endl;
    return 0;
}